...
(function () {
  ...
  class CampusMapController {
    ...
    init() {
      ...
      // Continuously watch user's real position via Geolocation API
      this.startWatchingPosition(false);
    }
    ...
    setupEventListeners() {
      ...
      if (mapLocateBtn) mapLocateBtn.addEventListener("click", triggerRecenter);
